package kr.or.medif.config;

import kr.or.medif.common.handlers.CustomLoginFailureHandler;
import kr.or.medif.common.handlers.CustomLoginSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .mvcMatchers("/expert/**", "/device/**", "/ui/**","/node_modules/**","/loginFailure","/message","/error"
